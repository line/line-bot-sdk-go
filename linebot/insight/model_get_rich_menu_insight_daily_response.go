...
type GetRichMenuInsightDailyResponse struct {
	 ...
	 * Get Impression
	 */
	Impression *GetRichMenuInsightDailyResponseImpression `json:"impression,omitempty"`

	/**
	 * Daily click metrics for each tappable area of the rich menu.
	 */
	Clicks []GetRichMenuInsightDailyResponseClick `json:"clicks,omitempty"`
}

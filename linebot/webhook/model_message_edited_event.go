...
func (cr *MessageEditedEvent) UnmarshalJSON(data []byte) error {
...
// MarshalJSON customizes the JSON serialization of the MessageEditedEvent struct.
func (r *MessageEditedEvent) MarshalJSON() ([]byte, error) {

	r.Source = setDiscriminatorPropertySource(r.Source)

	r.Message = setDiscriminatorPropertyMessageContent(r.Message)

	type Alias MessageEditedEvent
